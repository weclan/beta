...
<?php
	$create_city_url = base_url()."store_cities/create";
?>
		...
		<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
			<div class="row align-items-center">
				...
				<div class="col-xl-4 order-1 order-xl-2 m--align-right">
					<a href="<?= $create_city_url ?>" class="btn btn-accent m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
						<span>
		...
		<table class="m-datatable" id="html_table" width="100%">
			...
			<tbody>
				...
				foreach ($query->result() as $row) { 
			  		$edit_city = base_url()."store_cities/create/".$row->id_kab;
			  		$status = $row->status;
				...
				<tr>
					...
					<td data-field="Actions" class="m-datatable__cell">
						<span style="overflow: visible; width: 110px;">						
							...
							<a href="<?= $edit_city ?>" class="m-portlet__nav-link btn m-btn m-btn--hover-accent m-btn--icon m-btn--icon-only m-btn--pill" title="Edit details">							
								<i class="la la-edit"></i>						
							</a>						
							<a href="#" class="m-portlet__nav-link btn m-btn m-btn--hover-danger m-btn--icon m-btn--icon-only m-btn--pill" title="Delete" data-toggle="modal" data-target="#<?= $row->id_kab ?>">							
					...
					<!--begin::Modal-->
						<div class="modal fade" id="<?= $row->id_kab ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
							<div class="modal-dialog" role="document">
								<div class="modal-content">
									...
									echo form_open('store_cities/delete/'.$row->id_kab, $attributes);
									?>
