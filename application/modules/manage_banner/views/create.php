...
<div class="m-portlet m-portlet--tab">
	<div class="m-portlet__head">
		...
		<?php 
		$upload_image = base_url()."manage_banner/upload_image/".$update_id;
		$delete_image = base_url()."manage_banner/delete_image/".$update_id;
	...
	<?php 
	$form_location = base_url()."manage_banner/create/".$update_id; 
	?>
	<form class="m-form m-form--fit m-form--label-align-right" method="post" action="<?= $form_location ?>">
		<div class="m-portlet__body">
			...
			<div class="form-group m-form__group row">
				...
				<div class="col-10">
					<input class="form-control m-input m-input--air" type="text" id="link" name="link" value="<?= $link ?>">
					<div class="form-control-feedback" style="color: #f4516c;"><?php echo form_error('link'); ?></div>
				</div>
			</div>
			...
			<div class="form-group m-form__group row">
				...
				<div class="col-10">
					<textarea class="form-control m-input m-input--air" id="exampleTextarea" rows="3" name="deskripsi"><?= $deskripsi ?></textarea>
					<div class="form-control-feedback" style="color: #f4516c;"><?php echo form_error('deskripsi'); ?></div>
				</div>
			</div>
