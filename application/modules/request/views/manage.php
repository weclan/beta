		...
		<div class="m-form m-form--label-align-right m--margin-top-20 m--margin-bottom-30">
			<div class="row align-items-center">
				...
				<div class="col-xl-6 order-1 order-xl-2 m--align-right">
					<a href="<?= $show_archieve_request ?>" class="btn btn-success m-btn m-btn--custom m-btn--icon m-btn--air">
						<span>
						...
						<span style="overflow: visible; width: 110px;">						
							<div class="dropdown ">							
								...
								<div class="dropdown-menu dropdown-menu-right">						    	
									...
									<a class="dropdown-item" href="#" onclick="showAjaxModal('<?= base_url()?>modal/popup/archieve_request/<?=$row->id?>/request');"><i class="la la-archive"></i> Archive</a>						    	
