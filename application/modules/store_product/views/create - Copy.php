        ...
        <div class="modal-content">
            ...
            <div class="row form-group">
                ...
                <div class="col-sms-3 col-sm-3 format">
                    ...
                    <?php  
                    // if($was_price != '') {
                    //     $this->site_settings->currency_format($was_price);
                    // }     
                    ?>">
        ...
        <h4 class="modal-title" id="myModalLabel">Modal title</h4>
            ...
            <div class="row form-group">
                ...
                <div class="col-sms-4 col-sm-4">
                    <input type="text" class="input-text full-width" name="was_price" value="<?php  
                    // if($item_price != '') {
                    //     $this->site_settings->currency_format($item_price);
                    // }     
                    ?>" disabled="disabled">
                </div>
                <div class="col-sms-3 col-sm-3">
