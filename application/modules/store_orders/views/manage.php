...
setInterval(gettabel(), 3000);
	...
	function gettabel(){
        jQuery.ajax({
            type: 'POST',
            url: '<?= base_url() ?>store_orders/getData',  
            dataType: 'json',
        ...
        var d=$(".m_datatable").mDatatable({data:{type:"local",source:data,pageSize:10},
            layout:{
                ...
                columns:[
		            ...
		            {field:"ID Order", sortable:!1, textAlign:"left", title:"ID Order"},
		            {field:"Lokasi", sortable:!1, textAlign:"left", title:"Lokasi"},
		            {field:"Harga", sortable:!1, textAlign:"left", title:"Harga"},
		            {field:"Durasi", sortable:1, textAlign:"left", title:"Durasi"},
		            ...
		            {field:"NO Transaksi", sortable:1, textAlign:"center", title:"No Transaksi"},
    ...
    function hapus_dokumen(id){
		...
		.then(function(e){
			e.value&&
		  	$.ajax({
	        type : "POST",
	        url  : "<?php echo base_url()?>store_orders/delete/" + id ,
	        // dataType : "JSON",
	                // data : {kode: kode},
