...
<?php } ?>
  ...
  <tbody>
    <tr>
      <td valign="top" width="60"><img src="<?= base_url() ?>marketplace/images/logo.png" alt="Logo" title="Logo" width="60" height="60" data-max-width="100"></td>
  ...
  <tbody>
    ...
    <tr>
      <td valign="top" width="580"><div class='contentEditableContainer contentImageEditable'>
                      <div class='contentEditable' style="text-align: center;"><img class="banner" src="<?= base_url() ?>marketplace/images/bigImg.png" alt="Logo" title="Logo" width="580" height="221" border="0"></div></div></td>
    </tr>
  </tbody>
</table>
