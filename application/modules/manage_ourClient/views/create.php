...
<div class="m-portlet m-portlet--tab">
	<div class="m-portlet__head">
		...
		<?php 
		$upload_image = base_url()."manage_ourClient/upload_image/".$update_id;
		$delete_image = base_url()."manage_ourClient/delete_image/".$update_id;
	...
	<?php 
	$form_location = base_url()."manage_ourClient/create/".$update_id; 
	?>
