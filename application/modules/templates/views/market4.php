                        ...
                        <div class="col-sm-6 col-md-9">
                            ...
                            <div class="col-sm-6 col-md-3">
                                ...
                                <ul class="discover triangle hover row">
                                    ...
                                    <li class=""><a href="<?php echo base_url() ?>panduan/?p=cara-pembayaran">Negoisasi</a></li>
                                    <!-- <li class=""><a href="<?php echo base_url() ?>panduan/?p=pengembalian-dana">Pengembalian Dana</a></li>-->
                                    <li class=""><a href="<?php echo base_url() ?>panduan/?p=cara-pembayaran">Mendapatkan Penawaran</a></li>
