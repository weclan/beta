                    ...
                    <div class="row2">
                        ...
                        <div class="col-lg-12 listing-style3 cruise">
                            ...
                            <article class="box">
                                ...
                                <div class="details col-sm-8">
                                    <div class="clearfix">
                                    	<div class="col-xs-7 alamat-lokasi">
                                				...
                                				<h5 class="box-title pull-left" style="line-height: 18px; display: block;"><i class="soap-icon-departure yellow-color"></i> <a href="<?= $view_product ?>"><?= $row->item_title ?> </a></h5>
                                			
                                        	<div>
                                        		<span class="skin-color" style="display: block;"><strong>#<?= $kode_produk ?></strong></span>
                                        	</div>
                                    ...
                                    <div class="character clearfix">
                                        <div class="col-xs-3 date">
                                            ...
                                            <div class="col-xs-3">
                                                ...
                                                <!-- <a href="#" onclick="showAjaxModal('<?= base_url()?>modal/popup/edit_cart/<?= $row->basket_id ?>/cart');" data-toggle="modal" data-target="#m_modal" title="edit">
                          	...
                          	<div class="col-md-4" style="background: #fff; padding: 10px; box-shadow: 0 5px 20px 0 rgba(80,106,172,0.3); margin-bottom: 20px;"> 
                          		<div >
                          			<!-- <h3>Checkout</h3>
                          			<hr> -->
                                    ...
                                    <a href="<?php echo base_url().'cart/final/'.$checkout_token; ?>">
										<button class="button btn-large orange full-width">Finalisasi Order</button>
									</a>
