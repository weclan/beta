			        ...
			        <div class="row2">
			            <div class="col-sm-6">
			                <div class="style102">
			                    ...
			                    <p class="description">
			                    	Kamu dapat melakukan pembayaran ke rekening Wiklan melalui Transfer Panin Bank, BCA Bank dan banyak lagi metode lainnya
			                    </p>
			                </div>
			            </div>
			            <div class="col-sm-6">
			            ...
			            <div class="col-sm-6">
			                <div class=" style102">
								...
								<ul class="klik-purchase">
									...
									<li><span class="description">Masuk ke halaman payment confirmation Wiklan untuk tahapan selanjutnya dalam konfirmasi pembayaran melalui metode transfer kemudian lengkapi data sesuai dengan nominal yang di transfer ke halaman payment confirmation</span>
									</li>
									<li><span class="description">Tekan Kirim Konfirmasi Pembayaran.</span>
									</li>
								</ul>
			                </div>
			            </div>
