			            ...
			            <div class="col-sm-12">
			                <div class="style102">
			                	<div class="container2 pad-30">
									<h1 class="tebal">Beriklan di Wiklan</h1>
	                                <p class="description">
	                                	Wiklan membawa kabar gembira untuk Anda semua, pemesan dan penjual, pengguna loyal kami. Kini, Wiklan memberikan fitur baru, yakni fitur diskon
	                                </p>
	                                <p class="description">
								...
								<ul class="klik-purchase">
									<li><span class="description">Buka halaman Jual Media Iklan</span>
									</li>
									<li><span class="description">Pilih produk yang akan didiskon > Apa yang dijual pilih Set Diskon</span>
									</li>
									<li><span class="description">Pemilik titik dapat mengajukan diskon untuk beberapa media iklan dengan cara mencentang beberapa media iklan lalu pilih tombol Set Diskon</span>
									</li>
									<li><span class="description">Pemilik titik memasukkan besarnya diskon dan tanggal berlaku diskon. Tanggal berlaku diskon dapat dimulai dari hari saat melakukan set diskon sampai dengan 1 hari atau 1 bulan ke depan</span>
									</li>
									<li><span class="description">Pemilik titik tidak dapat melakukan perubahan nominal dan tanggal berlaku diskon jika diskon sudah diset</span>
									</li>
									<li><span class="description">Pemilik titik dapat melihat detail diskon yang akan atau sedang berlaku pada halaman Jual Media Iklan, menu Lihat Rincian pada media iklan yang sedang didiskon</span>
									</li>
									<li><span class="description">Pemilik titik juga dapat menghapus diskon yang sudah diset pada halaman barang Jual Media Iklan, menu lihat rincian, klik text button Hapus Diskon</span>
									</li>
								</ul>
								<br>
