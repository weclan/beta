			            ...
			            <div class="col-sm-6">
			                <div class=" style102">
								<ul class="klik-purchase">
									<li><span class="description">Ketika ingin mengakses www.wiklan.com, periksa boks alamat (address bar). <span class="tebal">Pastikan alamat yang Anda akses menggunakan domain wiklan.com dan diawali https://, seperti https://www.wiklan.com, https://wiklan.business.site/</span>. Jika situs yang Anda akses menyerupai halaman wiklan namun memiliki alamat berbeda, segera tutup halaman tersebut.</span>
									</li>
			            ...
			            <div class="col-sm-6 pad-30">
			                <div class="icon-box style102">
			                    <ul class="klik-purchase">
									...
									<li><span class="description">Anda diminta untuk bersikap <span class="tebal">waspada terhadap tautan eksternal yang diberikan via pesan pribadi atau private message (PM)</span>. Untuk semua tautan yang berada di luar sistem https://www.wiklan.com, sistem akan langsung mengarahkan ke halaman peringatan terlebih dulu. Dengan mengakses tautan di luar sistem https://www.wiklan.com, Wiklan tidak bisa menjamin keamanan transaksi Anda.</span>
									</li>
									
									<li><span class="description"><span class="tebal">Wiklan tidak pernah meminta data pribadi, nama akun (username), dan/atau kata sandi (password) melalui e-mail, telepon, ataupun pesan pribadi (PM/private message). Jika ada pihak yang mengatasnamakan Wiklan dan meminta data-data tersebut mohon abaikan.</span>
									</li>
