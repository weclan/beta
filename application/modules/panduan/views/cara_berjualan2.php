            ...
            <div class="tab-content">
                <div class="tab-pane fade active in" id="jual">
                    ...
                    <div class="col-md-3">
                        ...
                        <p class="text-center">Upload produk yang ingin kamu jual pada halaman Jual Media Iklan, yang terletak di dashboard website Wiklan</p>
                    </div>
                    <div class="col-md-3">
                        <span class="besar">
                    ...
                    <div class="col-md-3">
                        ...
                        <p class="text-center">Jika informasi produk sudah diisi, selesaikan jual media iklan dengan klik tombol "Simpan"</p>
                    </div>
                </div>
                    ...
                    <div>
                        ...
                        <ul>
                            <li>
                                ...
                                <div class="col-md-8">
                                    <p>Lihat pesanan barumu dengan melakukan salah satu cara di bawah ini:</p>
                                    <ul class="klik-purchase">
                                        <li>
                                            <p>1.  Buka menu "Transaksi" bagian tab "Penjualan". Lakukan filter status transaksi "Dibayar", atau</p>
                                        </li>
                                        <li>
                                            <p>2.  Masuk langsung ke halaman detail transaksimu dengan mengklik link pada notifikasi yang kamu dapatkan</p>
                                        </li>
                                    </ul>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="col-md-8">
                                    <p>Periksa apakah produk yang dipesan tersedia atau tidak</p>
                                </div>
                            </li>
                            <li>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <p>Lakukan konfirmasi pada pembeli bahwa transaksi sedang kamu proses dengan mengklik tombol proses</p>
                                </div>
                            </li>
                            <li>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <p>Produksi dan pasang meteri media iklan dengan baik</p>
                                </div>
                            </li>
                            <li>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <p>Pastikan titik berdiri pemasangan media iklan sudah sesuai dengan pesanan pembeli</p>
                                </div>
                            </li>
                            <li>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <p>Tayangkan materi iklan sesuai dengan pesanan pembeli, sebelum deadline yang tertera di detail transaksi</p>
                                </div>
                            </li>
                            <li>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    <p>Tunggu materi iklan pembeli tayang, kemudian uang akan remit (diteruskan dari wiklan) ke rekening bank mu</p>
                                </div>
                            </li>
                        </ul>    
