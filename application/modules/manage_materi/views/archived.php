...
<div class="m-portlet m-portlet--mobile">
	<div class="m-portlet__head">
		...
		<div class="m-portlet__head-tools">
			<a href="<?= base_url() ?>manage_materi/manage" class="btn btn-warning m-btn m-btn--custom m-btn--icon m-btn--air m-btn--pill">
				<span>
...
setTimeout(gettabel, 3000);
	...
	function gettabel(){
        jQuery.ajax({
            type: 'POST',
            url: '<?= base_url() ?>manage_materi/getDataArchive',  
            dataType: 'json',
