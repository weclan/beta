...
?>
    ...
    <body paddingwidth="0" paddingheight="0" bgcolor="#d1d3d4" style="padding-top: 0; padding-bottom: 0; padding-top: 0; padding-bottom: 0; background-repeat: repeat; width: 100% !important; -webkit-text-size-adjust: 100%; -ms-text-size-adjust: 100%; -webkit-font-smoothing: antialiased;" offset="0" toppadding="0" leftpadding="0">
                                                                                            ...
                                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                                <tbody>
                                                                                                    <tr>
                                                                                                        ...
                                                                                                        <td valign="top" width="0" class="spechide hidden-print">&nbsp;</td>
                                                                                                        ...
                                                                                                        <td valign="middle" class="hidden-print" style='vertical-align: middle;' width='150'>
                                                                                                            <div class='contentEditableContainer contentTextEditable'>
                                                                                                                <div class='contentEditable' style='text-align: right;'>
                                                                                                        ...
                                                                                                        <td valign="middle" class="show-print" style='vertical-align: middle; display: none;' width='350'>
                                                                                                            <div class='contentEditableContainer contentTextEditable'>
                                                                                                                <div class='contentEditable' style='text-align: right;'>
                                                                                                                    <h2 style="font-size: 13px; font-weight: bold;"><?= $meta_author ?></h2>
                                                                                                                    ...
                                                                                                                    <td>
                                                                                                                        <div class='contentEditableContainer contentTextEditable'>
                                                                                                                            <div class='contentEditable' style='text-align: center;'>
                                                                                                                                <h2 style="font-size: 14px; font-weight: bold;"><?= $alamat ?><br><?= $kota ?> - <?= $prov ?></h2>
        ...
        if ($image_location2 != '') { ?>
                                                                                                        ...
                                                                                                        <img src="<?= $image_location2 ?>" class="banner" title="Lokasi" style='height: 100%; width: 100%; object-fit: contain'>
                                                                                                        <?php } else { ?>
                                                                                                        ...
                                                                                                        <td class="specbundle" width="70%">
                                                                                                            <div class='contentEditableContainer contentTextEditable'>
                                                                                                                <div class='contentEditable' style='text-align: left;'>
                                                                                                                    <h2 style="font-size: 16px; font-weight: bold;">Keterangan</h2>
                                                                                                                    <p style="color: #000000; font-weight: bold;">
                                                                                                                        <?= $kategori_produk.' - '.$size.'m - '.$display ?>
                                                                                                                    </p>
                                                                                                                    <p style="color: #000000; font-weight: bold;">
                                                                                                                        <?= $jml_sisi.' - '.$tipe_cahaya ?>
                                                                                                                    </p>
                                                                                                                </div>
                                                                                                            </div>
                                                                                                        </td>
              ...
              if ($code != '') { ?>
                                                                        ...
                                                                        <div class="movableContent hidden-print" style="border: 0px; padding-top: 0px; position: relative;">
                                                                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <td height="30"></td>
  ...
  <tbody>
    ...
    * The callback parameter executes the initMap() function
    -->
        <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAoUOdMzbYns5TcDrLZYMEuXhUGkV5QIoo&callback=initMap">
        </script>
