...
<div class="m-portlet m-portlet--tab">
	<div class="m-portlet__head">
		...
		<?php 
		$upload_image = base_url()."manage_testimoni/upload_image/".$update_id;
		$delete_image = base_url()."manage_testimoni/delete_image/".$update_id;
	...
	<?php 
	$form_location = base_url()."manage_testimoni/create/".$update_id; 
	?>
	<form class="m-form m-form--fit m-form--label-align-right" method="post" action="<?= $form_location ?>">
		<div class="m-portlet__body">
			...
			<div class="form-group m-form__group row">
				...
				<div class="col-10">
					<input class="form-control m-input m-input--air" type="text" id="profil" name="profil" value="<?= $profil ?>">
					<div class="form-control-feedback" style="color: #f4516c;"><?php echo form_error('profil'); ?></div>
				</div>
			</div>
			...
			<div class="form-group m-form__group row">
				...
				<div class="col-10">
					<textarea class="form-control m-input m-input--air" id="exampleTextarea" rows="3" name="testimoni"><?= $testimoni ?></textarea>
					<div class="form-control-feedback" style="color: #f4516c;"><?php echo form_error('testimoni'); ?></div>
				</div>
			</div>
