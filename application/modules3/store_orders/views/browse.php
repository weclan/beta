...
<div class="form-actions1">
	...
	<p style="margin-top:30px">
		<a href="<?php echo $paypal_url ?>"><button type="button" class="btn btn-primary">Visit Paypal</button></a>
	</p>
</div>
...
<?php
if ($num_rows < 1) {
	echo "<p>There are currently no orders with this status.</p>";
} else {
...
<div class="row-fluid sortable">		
				<div class="box span12">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Your Order </h2>
						<div class="box-icon">
					...
					<div class="box-content">
						<table class="table table-striped table-bordered bootstrap-datatable datatable2">
						  ...
						  <tbody>
							...
							<tr>
								<td><?= $row->order_ref ?></td>
								<td class="center"><?= $row->mc_gross ?></td>
								<td><?= $date_created ?></td>
