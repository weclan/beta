			            ...
			            <div class="col-sm-12">
			                <div class="style102">
	                            ...
	                            <ul class="klik-purchase">
									<li><span class="description">Klik, lalu pilih Status Pemesanan.</span>
									</li>
									<li><span class="description">Klik Komplain pada pesanan produk yang belum selesai.</span>
									</li>
									<li><span class="description">Akan muncul pop up. Silakan pilih Belum Selesai.</span>
									</li>
									<li><span class="description">Anda akan masuk ke halaman Pusat Solusi. Jelaskan masalah Anda secara detail di kolom yang sudah disediakan. Klik Berikutnya.</span>
									</li>
									<li><span class="description">Tulis jumlah dana yang Anda inginkan. Lalu klik Komplain.</span>
									</li>
	                            ...
	                            <ul class="klik-purchase">
									<li><span class="description">Klik, lalu pilih Konfirmasi Belum Tayang.</span>
									</li>
									<li><span class="description">Klik Komplain pada pesanan produk yang belum selesai.</span>
									</li>
									<li><span class="description">Akan muncul pop up. Silakan pilih Belum Selesai.</span>
			            ...
			            <div class="col-sm-12">
			                <div class=" style102">
			                	<div class="container2 pad-30">
				                	...
				                	<ul class="klik-purchase">
				                		<li><span class="description">Klik pada halaman Dashboard Wiklan, lalu klik Status Pemesanan.</span></li>
										<li><span class="description">Klik Komplain pada pesanan yang berkendala.</span></li>
										<li><span class="description">Akan muncul pop up, dan silakan pilih Sudah Tayang.</span></li>
										<li><span class="description">Silakan pilih masalah yang dihadapi, yaitu:</span>
											<br>
											<h3>Masalah pada iklan tayang</h3>
											...
											<ul class="klik-purchase">
												<li><span class="description">Setelah memilih kategori masalah Terkait Produk, tentukan produk yang ingin Anda komplain. Pilih komplain yang ingin Anda sampaikan ke pemilik titik. Isi juga keterangan produk yang rusak/tidak sesuai/materi salah serta jelaskan masalah Anda dengan lebih detail di kolom yang sudah disediakan.</span>
												</li>
												<li><span class="description">Klik Berikutnya.</span>
												</li>
												<li><span class="description">Lampirkan foto media iklan yang bermasalah. Anda bisa melampirkan hingga 5 foto sekaligus.</span>
												</li>
												<li><span class="description">Pilih solusi Retur Produk dan Kembalikan Dana. Tentukan jumlah dana yang diinginkan, lalu klik Komplain.</span>
												</li>
												<li><span class="description">Selanjutnya, Anda tinggal menunggu tanggapan dari pemilik titik di halaman Pusat Solusi. Jika dalam waktu 14×24 jam tidak ada tanggapan dari pemilik titik, Anda dapat mengklik Minta Bantuan untuk meminta bantuan Customer Support Wiklan.</span>
												</li>
												<li><span class="description">Dana akan dikembalikan ke Saldo Rekening Anda saat pemilik titik sudah mengklik Selesaikan Komplain dan menyetujui dana dikembalikan.</span>
												</li>
											</ul>
