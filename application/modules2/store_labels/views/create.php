...
<div class="m-portlet m-portlet--tab">
	...
	<?php 
	$form_location = base_url()."store_labels/create/".$update_id; 
	?>
	<form class="m-form m-form--fit m-form--label-align-right" method="post" action="<?= $form_location ?>">
		<div class="m-portlet__body">
			...
			<div class="form-group m-form__group row">
				...
				<div class="col-10">
					<input class="form-control m-input m-input--air" type="text" id="label_title" name="label_title" value="<?= $label_title ?>">
					<div class="form-control-feedback" style="color: #f4516c;"><?php echo form_error('label_title'); ?></div>
				</div>
			</div>
