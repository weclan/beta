                                    ...
                                    <div class="component">
										<form class="form-horizontal">
											<div class="form-group">
											    ...
											    <div class="col-sm-8">
											      <input type="text" class="form-control" id="" name="dp" placeholder="DP">
											    </div>
											</div>
											...
											<div class="form-group">
											    <label for="" class="col-sm-4 control-label">Pelunasan</label>
											    <div class="col-sm-8">
											      <input type="text" class="form-control" id="" name="final_instalment" placeholder="pelunasan">
											    </div>
											</div>
										</form>
									</div>
