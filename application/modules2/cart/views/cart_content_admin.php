<div class="row-fluid sortable">
	<div class="box span12">
		<div class="box-header" data-original-title>
			<h2><i class="halflings-icon white shopping-cart"></i><span class="break"></span>Shopping Cart Detail</h2>
			<div class="box-icon">
			...
			<table class="table table-bordered">
				...
				<tr>
					<td class="col-md-2">
						...
						<?php 
							...
							echo "No image preview avalaible";
						}
						?>
				...
				<tr>
					...
					<td style="font-weight: bold;">
						...
						echo $currency_symbol.$sub_total_desc; 
					 	?>
					 </td>
				</tr>
