...
<div class="m-portlet m-portlet--tab">
	...
	<?php 
	$form_location = base_url()."store_cities/create/".$update_id; 
	?>
			...
			<div class="form-group m-form__group row">
				...
				<div class="col-10">
			        ...
			        foreach ($prov->result_array() as $row) {
				  	...
				  	echo form_dropdown('id_prov', $kategori_prov, $id_prov, $additional_dd_code);
				  	?>
					<div class="form-control-feedback" style="color: #f4516c;"><?php echo form_error('id_prov'); ?></div>
				</div>
			</div>
			<div class="form-group m-form__group row">
				...
				<div class="col-10">
					<input class="form-control m-input m-input--air" type="text" id="id_kab" name="id_kab" value="<?= $id_kab ?>">
