			...
			<div class="image-style style12 box">
				...
				<div class="container">
			        <div class="row2">
			            <div class="col-sm-6">
			                <div class="style102">
			                	<h3 class="tebal">Cara Negoisasi di Wiklan</h3>
			                </div>
			            </div>
			            <div class="col-sm-6">
			            ...
			            <div class="col-sm-6">
			                <div class=" style102">
								<ul class="klik-purchase">
									<li><span class="description">Pilih titik lokasi dan durasi sewa yang diinginkan terlebih dahulu, kemudian <span class="tebal">Cetak Penawaran.</span>
									</li>
									<li><span class="description">Terkait penawaran harga bisa klik "<a href="<?php echo base_url() ?>templates/home#contact"><span class="tebal">Hubungi Kami</span></a>" atau email (cs@wiklan.com).</span>
									</li>
								</ul>
			                </div>
			            </div>
			                ...
			                <div class="icon-box style102">
			                    <p class="description">
			                    	<div class="img-center">
			                    		<img src="<?= base_url() ?>marketplace/images/negoisasi.png">
			                    	</div>
			                    </p>
			                </div>
			            </div>
