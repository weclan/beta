                ...
                <div class="row">
                	...
                	<div class="col-sms-6 col-sm-6 col-md-6">
                    	<div class="center pad-6">
                    		...
                    		<h4>Sudah punya akun Wiklan? Masuk <a href=""><span class="skin-color">di sini</span></a></h4>
                    	</div>
                            ...
                            <form class="booking-form">
                                <div class="person-information">
                                    ...
                                    <div class="form-group">
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox"> Dengan menekan Daftar Akun, saya mengkonfirmasi telah menyetujui, <a href="#"><span class="skin-color">Syarat dan Ketentuan</span></a> serta <a href="#"><span class="skin-color">Kebijakan Privasi</span></a> Wiklan.
                                            </label>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-sm-12 col-md-12">
                                        <button type="submit" class="full-width btn-large">DAFTAR AKUN</button>
                                    </div>
                                </div>
                            </form>
                        </div>
